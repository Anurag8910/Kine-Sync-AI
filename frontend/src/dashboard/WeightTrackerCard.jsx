...
//             {/* Chart Area */}
//             <div className="mt-4" style={{ minWidth: 250, minHeight: 200, width: '100%', height: 260 }}>
    ...
    return (
        <div className="bg-[#161B22] p-5 rounded-xl border border-gray-800 flex flex-col justify-between">
            ...
            <button
                type="button"
                onClick={() => navigate('/log-weight')}
                className="w-full mt-4 flex items-center justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700"
            >
                Log New Weight
            </button>
        </div>
